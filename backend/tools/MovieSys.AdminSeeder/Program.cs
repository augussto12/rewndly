...
var username = GetRequiredEnvironment("MOVIESYS_ADMIN_USERNAME").Trim();
var email = GetRequiredEnvironment("MOVIESYS_ADMIN_EMAIL").Trim().ToLowerInvariant();
var initialPassword = GetRequiredEnvironment("MOVIESYS_ADMIN_INITIAL_PASSWORD");
...
dbContext.SystemEvents.Add(new SystemEvent
{
    ...
    {
        source = "MovieSys.AdminSeeder",
        role = UserRole.Admin.ToString(),
        mustChangePassword = true
    }),
    UserAgent = "MovieSys.AdminSeeder"
});
