...
public sealed class LibraryItemRequestValidator : AbstractValidator<LibraryItemRequest>
{
    ...
    {
        return Enum.TryParse<MovieSys.Domain.Media.MediaType>(value, ignoreCase: true, out _);
    }

    private static bool BeWatchStatus(string value)
    {
        return Enum.TryParse<MovieSys.Domain.Library.WatchStatus>(value, ignoreCase: true, out _);
    }
}
...
public sealed class ReviewRequestValidator : AbstractValidator<ReviewRequest>
{
    ...
    {
        return Enum.TryParse<MovieSys.Domain.Reviews.ReviewVisibility>(value, ignoreCase: true, out _);
    }
}
...
public sealed class UserListRequestValidator : AbstractValidator<UserListRequest>
{
    ...
    {
        return Enum.TryParse<MovieSys.Domain.Lists.ListVisibility>(value, ignoreCase: true, out _);
    }
}
