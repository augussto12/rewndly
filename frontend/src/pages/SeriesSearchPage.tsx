  ...
  return (
    <PublicLayout>
      <main className="page-shell">
        <PageHeader eyebrow="Catálogo" title="Series" subtitle="Navegá series populares o buscá por nombre cuando querés ir directo a una." />
...
function getEmptyMessage(canSearch: boolean, hasPlatformFilter: boolean, kind: string) {
  ...
  return 'No encontramos series para esa búsqueda.'
}
