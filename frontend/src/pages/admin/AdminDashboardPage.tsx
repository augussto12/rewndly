  ...
  return (
    <AdminLayout>
      <main className="px-4 py-8 lg:px-8">
        <Header title="Dashboard" subtitle="Métrica operativa inicial de Rewndly." />
        ...
        {data ? (
          <>
            <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
              ...
              <AdminMetricCard label="Nuevos 7 días" value={data.newUsersLast7Days} />
              <AdminMetricCard label="Películas guardadas" value={data.savedMovies} />
              <AdminMetricCard label="Series guardadas" value={data.savedSeries} />
              <AdminMetricCard label="Reseñas" value={data.reviewsCreated} />
            ...
            <div className="mt-6 grid gap-4 lg:grid-cols-2">
              <Panel title="Contenido más guardado" items={data.mostSavedContent.map((item) => `${item.title} (${item.count})`)} />
